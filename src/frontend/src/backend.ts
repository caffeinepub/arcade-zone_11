...
export class Backend implements backendInterface {
    ...
    async addGame(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addGame(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getGameMetadata(): Promise<Array<GameMetadata>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGameMetadata();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalPlays(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
